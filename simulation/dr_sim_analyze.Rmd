...
The following table shows the empirical bias, empirical standard error (ESE), average estimated standard error (ASE), and empirical coverage probability of the crude and BC 95% CIs for the corrected estimators under the four model specification scenarios and a sample size $n=400$
