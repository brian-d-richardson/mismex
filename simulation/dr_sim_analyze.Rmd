...
The following table shows the empirical bias, empirical standard error (ESE), average estimated standard error (ASE), and mean squared error (MSE) of the nine estimators under the four model specification scenarios.
