...
If the propensity weights are known, or if they are estimated externally, then they can be supplied using the `ps.wts` argument. In this case, the sandwich variance estimator treats weights as known.
