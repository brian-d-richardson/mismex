...
For each scenario, we compare twelve methods:
...
5) Naive IPW
6) Naive DR
7) Regression Calibration G-Formula
8) Regression Calibration IPW
9) Regression Calibration DR
10) Corrected G-Formula
11) Corrected IPW
12) Corrected DR
