...
The goal of this program is to evaluate the Monte Carlo corrected score inverse probability weighting (MCCS IPW) estimator in the presence of confounding and measurement error, and in a scenario where the MSM is nonlinear.
...
In these simulations, we compare four methods:
...
sim.out.list <- lapply(
  ...
  FUN = function(clust) {
    cbind(clust,
          read.csv(paste0("sim_data/ipw_nonlinearmsm_data/sd",
                          clust, ".csv")))
  })
